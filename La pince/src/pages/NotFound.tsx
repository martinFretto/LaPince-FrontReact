			...
			<div className="border-[#1971c2] border-2 rounded-3xl mx-4 my-8 py-8 px-6 bg-[#a5d8ff] max-w-md w-full">
				<div className="flex flex-col items-center">
					...
					<p className="text-center mb-10 text-sm text-black">
						Cette page n'existe pas, mais tes économies elles, existent (on
						espère). Retourne vite les gérer !
					</p>
					<Link to="/dashboard">
						<button
							type="button"
							className="btn bg-[#4dabf7] border-2 border-[#1971c2] text-white text-md font-normal hover:cursor flex place-self-center"
						>
							Retour à l'accueil
						</button>
					</Link>
