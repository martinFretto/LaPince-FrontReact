		...
		<div className="max-w-4xl mx-auto py-8 px-4">
			...
			<section className="mb-8">
				...
				<ul className="list-disc pl-8 mb-3">
					<li className="mb-1">
						...
						donut coloré, c'est ce qu'il te reste à dépenser. Plus le cercle est
						complet, mieux c'est !
					</li>
					<li className="mb-1">
					...
					<li className="mb-1">
						...
						de tes dernières dépenses avec leur montant et leur catégorie
					</li>
				</ul>
				<p className="mb-3">
			...
			<section className="mb-8">
				...
				<div className="mb-4">
					...
					<ol className="list-decimal pl-8 mb-3">
						<li className="mb-1">
							Clique sur "Mes budgets" dans le menu en haut
						</li>
						<li className="mb-1">
				...
				<div className="mb-4">
					...
					<ol className="list-decimal pl-8 mb-3">
						<li className="mb-1">Va sur la page de détail du budget</li>
						<li className="mb-1">
