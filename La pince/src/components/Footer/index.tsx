...
>>>>>>> feature/expense-modal
				...
				<div className="flex flex-col items-center space-y-1 text-[0.6rem]">
					...
					<Link to="/legal-notices" className="text-black hover:text-gray-600">
						Mentions légales
					</Link>
					<Link to="/security-data" className="text-black hover:text-gray-600">
						Sécurité & Données
					</Link>
				...
				<div className="flex flex-col items-center">
					...
					<p className="text-black text-[0.6rem] mt-1">2025 © Copyright</p>
				</div>
			</div>
			...
			<div className="hidden md:grid md:grid-cols-12 md:items-center">
				...
				<div className="col-span-4 flex flex-col items-end space-y-1 text-sm">
					<Link to="/user-guide" className="text-black hover:text-gray-600">
						Mode d'emploi
					</Link>
					<Link to="/legal-notices" className="text-black hover:text-gray-600">
						Mentions légales
